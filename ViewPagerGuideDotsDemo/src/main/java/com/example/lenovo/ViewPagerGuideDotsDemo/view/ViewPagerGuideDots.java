package com.example.lenovo.ViewPagerGuideDotsDemo.view;
 ...
 */
public class ViewPagerGuideDots extends View {
    Paint paintNormal;
    Paint paintSelected;
    ...
    public ViewPagerGuideDots(Context context) {
        super(context);
    }

    public ViewPagerGuideDots(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public ViewPagerGuideDots(Context context, AttributeSet attrs, int defStyleAttr) {
